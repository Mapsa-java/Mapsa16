...
public class StudentUtils {
    ...
    public static List<ClassRoom> generateClassRoomList(){
        ...
        ClassRoom classRoom2 = new ClassRoom("class B");
        ClassRoom classRoom3 = new ClassRoom("class C");


        classRoom1.setStudents(Arrays.asList(
                                            students.get(0) ,
                                            students.get(1) ,
                                            students.get(2) ,
                                            students.get(3) ));

        classRoom2.setStudents(Arrays.asList(
                                            students.get(4) ,
                                            students.get(5) ,
                                            students.get(6) ,
                                            students.get(7) ,
        ...
        classRoom3.setStudents(Arrays.asList(
                                            students.get(13) ,
                                            students.get(14) ));


        List<ClassRoom> classRooms = new ArrayList<>(Arrays.asList(classRoom1,classRoom2,classRoom3));
        return classRooms;
    }
}
